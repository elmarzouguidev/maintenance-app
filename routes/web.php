...
Route::group(['middleware' => ['permission:add.tickes']], function () {

    Route::get('/add-tickes', [SiteController::class, 'welcom'])->name('test.welcom');
});

Route::group(['middleware' => ['can:add.admins']], function () {

    Route::get('/add-admin', [SiteController::class, 'welcom'])->name('test.welcom');
});
