...
namespace App\Http\Controllers\Authentification\Technicien;
...
class TechnicienLoginController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->middleware('guest:technicien')->except('logout');
    }

    public function loginForm()
    {
        return view('theme.Authentification.Technicien.Login.index');
    }
