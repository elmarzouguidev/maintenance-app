    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form id="companyForm" action="{{route('commercial:companies.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @honeypot
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input id="website" name="website" type="text" class="form-control @error('website') is-invalid @enderror" value="{{old('website')}}" >
                                @error('website')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input id="cnss" name="cnss" type="number" class="form-control @error('cnss') is-invalid @enderror" value="{{old('cnss')}}" >
                                @error('cnss')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
