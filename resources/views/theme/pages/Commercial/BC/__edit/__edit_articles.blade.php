    ...
    @foreach ($command->articles as $article)
        <div data-repeater-item class="row">
            ...
            <div class="mb-3 col-lg-1">
                ...
                <input type="number" name="quantity" id="quantity" value="{{ $article->quantity }}" step="1"
            ...
            <div class="mb-3 col-lg-2">
                ...
                <input type="number" name="prix_unitaire" id="prix_unitaire" step="0.1" value="{{ $article->prix_unitaire }}"
