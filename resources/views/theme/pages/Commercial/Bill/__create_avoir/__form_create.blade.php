<div class="row">
    <div class="col-lg-12">
        <form class="addBill" id="addBiller" action="{{ route('commercial:bills.storeBill.avoir',$invoice->uuid) }}" method="post">
            @csrf
            @honeypot
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            @include('theme.pages.Commercial.Bill.__create_avoir.__info')
                        ...
                        <div class="col-lg-6">
                            ...
                            @include('theme.pages.Commercial.Bill.__create_avoir.__info_bill')
