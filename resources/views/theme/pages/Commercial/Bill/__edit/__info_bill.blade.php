    ...
    <div class="col-lg-4">
        <div class="mb-4">
            ...
            <input type="text" name="price_total" class="form-control @error('price_total') is-invalid @enderror"
                value="{{ $bill->invoice->formated_price_total }}" max="{{ $bill->invoice->price_total }}" readonly>
            @error('price_total')
        ...
        <div class="mb-4">
            ...
            <div class="input-group" id="datepicker1">
                <input type="text" name="bill_date" class="form-control @error('bill_date') is-invalid @enderror"
                    value="{{ $bill->bill_date }}" data-date-format="dd-mm-yyyy" data-date-container='#datepicker1'
