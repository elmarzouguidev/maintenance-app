                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            @include('theme.pages.Commercial.Invoice.__create_avoir.__info')
                        ...
                        <div class="col-lg-6">
                            {{-- @include('theme.pages.Commercial.Invoice.__create_avoir.__javascript.__ajax_client') --}}
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-lg-12 mb-4">
                            @include('theme.pages.Commercial.Invoice.__create_avoir.__add_articles')
                        </div>
                        <div class="col-lg-6">
