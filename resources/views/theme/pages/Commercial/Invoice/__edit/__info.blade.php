<div class="row">
    ...
    <div class="col-lg-4">
        <div class="mb-4">
            ...
            <select name="client" class="form-control  @error('client') is-invalid @enderror" {{ $readOnly }}>
                <option value="{{ optional($invoice->client)->id }}">{{ optional($invoice->client)->entreprise }}
                </option>
            </select>
            @error('client')
                <span class="invalid-feedback" role="alert">
    ...
    <div class="col-lg-4">
        <div class="mb-4">
            ...
            <select name="ticket" class="form-control  @error('ticket') is-invalid @enderror" {{ $readOnly }}>

                @if (optional($invoice->ticket)->id)
