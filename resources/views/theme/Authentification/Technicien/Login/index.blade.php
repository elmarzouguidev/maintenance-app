...
<head>
    ...
    <meta charset="utf-8"/>
    <title>Login | Skote - Technicien & Dashboard Template</title>
            ...
            <div class="col-md-8 col-lg-6 col-xl-5">
                <div class="card overflow-hidden">
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="p-2">
                            <form autocomplete="off" class="form-horizontal" action="{{route('technicien:auth:loginPost')}}" method="post">
                                 @csrf
                                <div class="mb-3">
