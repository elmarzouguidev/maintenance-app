...
<head>
    ...
    <title>BL-{{ optional($command->client)->entreprise }} - {{ $command->date_bl?->format('d-m-Y') }}</title>
    <style>
        @page {
            margin: 60px 20px;
        }
                ...
                <table>
                    <tr>
                        <td style="width: 30% ;">
                            ...
                            {{ $command->city ?? 'Casablanca' }} le : {{ $command->date_bl->format('d-m-Y') }}<br/>
                        </td>
                        <td style="width: 30% ;">
                        </td>
                        <td style="width: 30% ;">
                            <strong>{{ optional($command->client)->entreprise }}</strong> <br/>
